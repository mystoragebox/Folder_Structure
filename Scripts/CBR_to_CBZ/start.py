# this simple script will convert cbr comic files into cbz files. There is no quality loss in the file images during the conversion. This script doesn't remove copy protection. 
